...
images_lego = LoadLF(path_lego, new_directory="grey_scale_rectified_lego")
images_fish_multi = LoadLF(path_fish_multi, new_directory="grey_scale_rectified_fish_multi")
images_fish_eye = LoadLF(path_fish_eye, new_directory="grey_scale_rectified_fish_eye")
images_fibers = LoadLF(path_fibers, new_directory="grey_scale_rectified_fibers")
images_ball = LoadLF(path_ball, new_directory="grey_scale_rectified_ball")
